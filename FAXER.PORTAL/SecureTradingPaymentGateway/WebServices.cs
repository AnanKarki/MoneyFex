...
namespace FAXER.PORTAL.SecureTradingPaymentGateway
{
    ...
    {
        public async Task<T> PostTransaction<T>(string request, string durl = "")
        {
            ...
            if (string.IsNullOrEmpty(durl))
            {
                ...
                url = WebServicesConfiguration.url;
            ...
            //String username = Common.Common.GetAppSettingValue("SecureTradingApiUserId").ToString();
            //String password = Common.Common.GetAppSettingValue("SecureTradingApiPassword").ToString();
            String username = "support@moneyfex.com";
            //String password = "MFstlog16&";
        ...
        public async Task<T> RefundTransaction<T>(string request, string durl = "")
        {
