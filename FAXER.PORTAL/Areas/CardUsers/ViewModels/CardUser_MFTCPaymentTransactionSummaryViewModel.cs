...
{
    public class CardUser_MFTCPaymentTransactionSummaryViewModel
    {
        public const string BindProperty = " ReceiverName,ReceiverMFTCCardNumber , ReceiveOption ,CardUserName, CardUserPhoneNumber , CardUserEmail ,CardUserCountry ,SenderMFTCCardNumber" +
