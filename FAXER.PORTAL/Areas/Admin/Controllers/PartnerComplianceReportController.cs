...
{
    public class PartnerComplianceReportController : Controller
    {
        // GET: Admin/PartnerComplianceReport
        CommonServices _CommonServices = null;

        public PartnerComplianceReportController()
        {
            _CommonServices = new CommonServices();
        }
        public ActionResult Index(string Country = "", string City = "", int PartnerId = 0, int? page = null)
        {
            ...
            //use viewbag as agent for partner
        ...
        public ActionResult UploadReport(int Id = 0, string Country = "", string City = "")
        {
            ...
            SetViewBagForCountries();
            //filter by AgentInformation Table in City
        ...
        {
            return RedirectToAction("Index", "PartnerComplianceReport");
        }
