...
namespace FAXER.PORTAL.Areas.Admin.Controllers
{
    public class PartnerAgentTransactionController : Controller
    {
        ...
        public ActionResult PartnerAgentTransactionList(int Id = 0, int transactionServiceType = 0, int year = 0, int month = 0, int Day = 0)
        {
