...
namespace FAXER.PORTAL.Areas.Admin.Controllers
{
    public class AgentPayInvoicingController : Controller
    {
        ...
        public ActionResult AgentPayInvoice()
        {
        ...
        {
            return RedirectToAction("AgentPayAnInvoiceSucess");
        }
        public ActionResult AgentPayAnInvoiceSucess()
        {
