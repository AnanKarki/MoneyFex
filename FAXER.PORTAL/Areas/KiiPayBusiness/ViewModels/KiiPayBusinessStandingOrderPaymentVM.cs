...
{
    public class KiiPayBusinessStandingOrderPaymentVM
    {
    }
    public class KiiPayBusinessStandingOrderPaymentListVM
    {
    ...
    public class BusinessStandingOrdervm
    {
    ...
    public class AddNewBusinessStandingOrderSuccessvm
    {
    ...
    public class UpdateBusinessStandingOrdervm
    {
